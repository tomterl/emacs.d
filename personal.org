...
#+BEGIN_SRC emacs-lisp
  ...
  (setq projectile-project-root-files-functions '(projectile-root-top-down projectile-root-bottom-up projectile-root-top-down-recurring))
...
#+BEGIN_SRC emacs-lisp
  (defvar tom/default-font "-unknown-Fira Mono-normal-normal-normal-*-10-*-*-*-m-0-iso10646-1"
    "The font to use under normal circumstances")
  (defvar tom/fallback-font "-unknown-Symbola-normal-normal-semicondensed-*-9-*-*-*-*-0-iso10646-1"
