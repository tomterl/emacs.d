...
I like the tabs and newline characters to have a fixed color.

#+BEGIN_SRC emacs-lisp
  (custom-set-faces
   '(tom/whitespace-face ((((class color))(:foreground "#999999"))) t))
  (add-hook
   'font-lock-mode-hook
   (function
    (lambda ()
      (setq font-lock-keywords
            (append font-lock-keywords
                    '(("\r" (0 'tom/whitespace-face t))
                      ("\t" (0 'tom/whitespace-face t))))))))
#+END_SRC
