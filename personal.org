...
#+BEGIN_SRC emacs-lisp
  ...
  (advice-add #'dashboard-insert-project-list :override
              #'(lambda (list-display-name list);
                  ...
                  (when (car list)
                    ...
                    (mapc (lambda (el)
                            ...
                            (widget-create 'push-button
                                           :action `(lambda (&rest ignore) (projectile-persp-switch-project ,el))
...
#+BEGIN_SRC emacs-lisp
  ...
  (spaceline-spacemacs-theme 'circe-tracking)
#+END_SRC
    ...
    (progn
      ...
      (local-set-key
       ...
       (defhydra hydra-js2-refactor (:color blue :timeout 5)
         "Refactor javascript"
         ("ta" #'js2r-toggle-arrow-function-and-expression "toggle arror")))
