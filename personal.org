...
** Tabs
   #+BEGIN_SRC emacs-lisp
     ...
     (centaur-tabs-mode t)
     (global-set-key (kbd "H-j")  'centaur-tabs-backward)
     (global-set-key (kbd "H-k") 'centaur-tabs-forward)
...
#+BEGIN_SRC emacs-lisp
  (setq
   ...
   org-todo-keywords '((sequence "TODO(t)" "ACTIVE(a)" "PAUSED(p)" "BLOCKED(b)" "DELEGATED(D)" "|" "CANCELED(c)" "DONE(d)"))
