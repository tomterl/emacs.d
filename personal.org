...
** Font
   ...
   #+BEGIN_SRC emacs-lisp
  (defvar tom/default-font "Courier Prime Code-11"
...
Scroll faster in large buffers; using poly-modes heavily in js or php
files slows emacs down a lot.

#+BEGIN_SRC emacs-lisp
(require 'fast-scroll)
(add-hook 'fast-scroll-start-hook (lambda () (flycheck-mode -1)))
(add-hook 'fast-scroll-end-hook (lambda () (flycheck-mode 1)))
(add-hook 'fast-scroll-start-hook (lambda () (beacon-mode -1)))
(add-hook 'fast-scroll-end-hook (lambda () (beacon-mode 1)))
(fast-scroll-config)
(fast-scroll-mode 1)
#+END_SRC
** Insert current date
...
;;  (add-hook 'after-save-hook 'tom/php-tags-update)
      ...
      (setq flycheck-phpstan-executable "/home/tregner/bin/phpstan")
