...
#+BEGIN_SRC emacs-lisp
  (defun tom/gnus ()
    ...
    (setq ldap-ldapsearch-args (quote ("-tt" "-LL" "-x" "-ZZ")))
    ...
    (let ((ldapv (netrc-machine (netrc-parse "~/.netrc") "ldapv")))
      (setq ldap-host-parameters-alist
            `(("ldapv.magora.com" base "ou=Users,dc=magora,dc=com"
               binddn ,(netrc-get ldapv "login")
               passwd ,(netrc-get ldapv "password")
               ))))
    (setq ldap-default-host "ldapv.magora.com")
    (eudc-set-server "ldapv.magora.com" 'ldap t)
    (setq eudc-server-hotlist '(("ldapv.magora.com" . ldap)))
    ...
    (eval-after-load "post"
      '(define-key post-mode-map (kbd "TAB") 'enz-eudc-expand-inline)))The 
#+END_SRC
