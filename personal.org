  ...
  (defun tom/build-tunnel-args (args)
    ...
    (let ((arglist '("-v")))
      (progn
        ...
        (add-to-list 'arglist
                     (concat (getf args :localport)
                             ":"
                             (getf args :tunnel-ip)
                             ":"
                             (getf args :tunnel-port)) t)
        (add-to-list 'arglist "-l" t)
        (add-to-list 'arglist (getf args :user) t)
        (add-to-list 'arglist "-p" t)
        (add-to-list 'arglist (getf args :port) t)
        (add-to-list 'arglist (getf args :host) t)
        arglist)))
#+END_SRC
