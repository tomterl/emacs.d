...
(custom-set-faces
 ...
 '(sidebar-ignored-dir ((t (:foreground "gray45"))))
 '(sidebar-ignored-file ((t (:foreground "gray45"))))
 '(sidebar-untracked ((t (:foreground "gray40")))))
