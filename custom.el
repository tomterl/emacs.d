...
(custom-set-faces
 ...
 '(geben-breakpoint-face ((t (:background "dark red" :foreground "light gray" :weight bold))))
 '(hi-yellow ((t (:background "tomato" :foreground "black"))))
